...
// Servo adjustment
#define _DUTY_MAX 2060  // Servo angle: D degree
#define _DUTY_NEU 1440  // Servo angle: 0 degree, 바꾸기 ㄱ
#define _DUTY_MIN 1033   // Servo angle: E degree
#define _SERVO_ANGLE_DIFF 60 // Replace with |D - E| degree, 바꾸기 ㄱ
#define _SERVO_SPEED 100 // servo speed limit (unit: degree/second)

#define _BANGBANG_RANGE 180
...
// Replace the below line with the equation obtained from nonlinear regression analysis
  return 950 + -6.52*a_value + 0.0202*a_value*a_value + -3E-05*a_value*a_value*a_value + 1.67E-08*a_value*a_value*a_value*a_value;
  // 627 + -3.17x + 6.19E-03x^2 + -4.33E-06x^3
}
